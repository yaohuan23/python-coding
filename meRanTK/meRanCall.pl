...
#  meRanCall.pl
#
#  Copyright 2016 Dietmar Rieder <dietmar.rieder@i-med.ac.at>
#
...
sub meth_caller {
    ...
    if (@$p) {
        ...
        for my $pileup (@$p) {
            ...
            #  print $a->qname . " : " . $a->cigar_str . " : ". length($a->qseq) .  " : " . $pileup->pos . "\n";
        ...
        ( my $refbaseRev = $refbase )          =~ tr/[ACGT]/[TGCA]/;
        ( my $contextRev = reverse($context) ) =~ tr/[ACGTacgt]/[TGCAtgca]/;
...
Options:
    ...
    -fskip5|-fs5           : number or bases to ignore on the 5' end of a forward
                             ...
                             plot from rnaBSMstar or rnaBSMBowtie2 output to get
